  ...
  const statCards = [
    {
      ...
      icon: Eye,
      color: 'text-accent dark:text-rose-600',
      bg: 'bg-red-50 dark:bg-accent/10',
    },
    {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
            ...
            <div className="lg:col-span-7 rounded-3xl border border-zinc-200/80 bg-white p-6 sm:p-8 shadow-sm dark:border-white/[0.08] dark:bg-[#0c121e]/70 space-y-6">
              <div className="flex items-center justify-between">
                ...
                <span className="rounded-full bg-red-50 dark:bg-accent/10 px-2.5 py-1 text-xs font-bold text-accent dark:text-rose-600">
                ...
                <div className="h-48 w-full flex items-end justify-between gap-3 sm:gap-4 pb-2">
                  {reportData.viewsTrend.map((item, i) => (
                    <div key={i} className="flex-1 h-full flex flex-col items-center justify-end group relative">
                      ...
                      <span className="text-[10px] font-bold text-accent dark:text-rose-600 opacity-0 group-hover:opacity-100 transition-opacity duration-150 mb-1 pointer-events-none whitespace-nowrap">
                        {item.rawViews} lượt
                      </span>
                      ...
                      <div className="w-full h-full flex items-end justify-center">
                        <div
                          ...
                          className="w-full max-w-[42px] rounded-t-xl bg-gradient-to-t from-accent via-accent-hover to-accent-2 group-hover:from-accent-hover group-hover:to-accent transition-all duration-300 cursor-pointer shadow-md shadow-accent/10"
                        />
                      </div>
                    </div>
                  ))}
