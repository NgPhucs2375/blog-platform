      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-8 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-zinc-200/80 dark:border-white/[0.08] pb-6">
          <div className="space-y-1.5">
            <div className="inline-flex items-center gap-2 rounded-full border border-indigo-500/20 bg-indigo-50 dark:border-indigo-500/30 dark:bg-indigo-500/10 px-3 py-1 text-xs font-bold text-indigo-700 dark:text-indigo-400">
          ...
          <button
            ...
            className="inline-flex items-center gap-2 rounded-xl bg-indigo-600 px-4 py-2.5 text-xs font-bold text-white shadow-md shadow-indigo-600/25 hover:bg-indigo-500 active:scale-95 transition"
          >
          ...
          >
            <div className="relative flex-1">
              ...
              <input
                ...
                className="w-full rounded-xl border border-zinc-200 bg-zinc-50 pl-10 pr-4 py-2 text-xs text-zinc-950 placeholder-zinc-400 focus:border-indigo-500 focus:bg-white focus:outline-none dark:border-white/10 dark:bg-white/[0.03] dark:text-white dark:placeholder-zinc-500 transition"
              />
            </div>
            ...
            <div className="flex flex-wrap items-center gap-2">
              <select
                ...
                className="rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-800 focus:border-indigo-500 focus:outline-none dark:border-white/10 dark:bg-[#0c101a] dark:text-zinc-200"
              >
                    ...
                    return (
                      <tr
                        ...
                        className={`hover:bg-zinc-50/80 dark:hover:bg-white/[0.02] transition ${
                          isSelected ? 'bg-indigo-50/40 dark:bg-indigo-500/[0.05]' : ''
                        }`}
                      >
                        {/* Checkbox */}
                        ...
                        <td className="py-4 px-4">
                          <div className="flex items-center gap-2">
                            <Link
                              href={`/users/${user.id}`}
                              className="font-bold text-zinc-950 dark:text-white hover:text-indigo-600 dark:hover:text-indigo-400 transition"
                            >
                              {user.userName}
                            </Link>
                            {isSelf && (
                          ...
                          <div className="flex items-center justify-end gap-1.5">
                            ...
                            {user.status === 'Active' && !isDeleted ? (
                              ...
                              <button
                                ...
                                disabled={busy}
                                className="rounded-lg border border-indigo-200 bg-indigo-50 px-2.5 py-1 text-[11px] font-semibold text-indigo-700 hover:bg-indigo-100 disabled:opacity-30 disabled:cursor-not-allowed dark:border-indigo-500/30 dark:bg-indigo-500/10 dark:text-indigo-400 transition"
                              >
                                Khôi phục
                              </button>
                            )}
            ...
            <form onSubmit={handleCreate} className="mt-5 space-y-4">
              <div>
                ...
                <input
                  ...
                  minLength={3}
                  maxLength={50}
                  className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3.5 py-2.5 text-xs text-zinc-950 placeholder-zinc-400 focus:border-indigo-500 focus:bg-white focus:outline-none dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder-zinc-500"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3 py-2 text-xs text-zinc-800 focus:border-indigo-500 focus:outline-none dark:border-white/10 dark:bg-[#0c101a] dark:text-zinc-200"
                  >
                    {ROLE_OPTIONS.map((opt) => (
                      <option key={opt.value} value={opt.value}>{opt.label}</option>
                    ))}
              ...
              <div className="flex items-center justify-end gap-3 border-t border-zinc-200 dark:border-white/10 pt-4">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-xl bg-indigo-600 px-5 py-2 text-xs font-bold text-white shadow-lg shadow-indigo-600/25 hover:bg-indigo-500 active:scale-95 disabled:opacity-50 transition"
                >
