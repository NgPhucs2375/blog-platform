...
export default function ProfilePage() {
  ...
  if (!mounted) {
    return (
      <div className="min-h-[75vh] flex flex-col items-center justify-center gap-3 bg-canvas text-muted transition-colors">
  ...
  return (
    <div className="min-h-screen bg-canvas text-ink transition-colors duration-200 pb-20">
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pt-10 space-y-8">
        ...
        {/* Banner hồ sơ */}
        <div className="rounded-3xl border border-line bg-surface p-6 sm:p-8 shadow-sm/80 flex flex-col sm:flex-row items-center gap-6">
          <div
            suppressHydrationWarning
            className="flex h-20 w-20 shrink-0 items-center justify-center rounded-2xl bg-gradient-to-tr from-rose-900 via-rose-800 to-purple-600 text-3xl font-black text-white shadow-lg shadow-rose-800/25"
          >
            {initialLetter}
          </div>
          ...
          <div className="space-y-2 text-center sm:text-left flex-1">
            ...
            <p
              suppressHydrationWarning
              className="text-xs sm:text-sm text-muted flex items-center justify-center sm:justify-start gap-1.5"
            >
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2 pt-1">
              <span
                suppressHydrationWarning
                className="inline-flex items-center gap-1 rounded-full border border-accent/20 bg-red-50 px-2.5 py-0.5 text-xs font-semibold text-accent dark:border-accent/30 dark:bg-accent/10 dark:text-red-300"
              >
                <Shield className="h-3 w-3" /> Vai trò: {role}
              </span>
              <span
                suppressHydrationWarning
                className="inline-flex items-center rounded-full border border-line bg-raised px-2.5 py-0.5 text-xs font-mono text-muted dark:bg-surface/5 dark:text-faint"
              >
                ID: #{userId}
              </span>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-3xl border border-line bg-surface p-6 sm:p-8 shadow-sm/80 space-y-5">
            <div>
              <h2 className="text-base font-bold text-ink flex items-center gap-2">
                <UserCircle className="h-4 w-4 text-accent dark:text-rose-600" />
                Thông tin tài khoản
              </h2>
              ...
              <div
                className={`flex items-center gap-2 rounded-2xl border px-3.5 py-2.5 text-xs font-medium ${
                  bioMessage.type === 'success'
                    ...
                    : 'border-rose-500/30 bg-rose-50 text-accent dark:bg-rose-500/10 dark:text-rose-300'
                }`}
              >
                {bioMessage.type === 'success' ? <Check className="h-4 w-4 shrink-0" /> : <WarningCircle className="h-4 w-4 shrink-0 text-rose-600" />}
            ...
            <form onSubmit={handleUpdateBio} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  disabled
                  value={username}
                  className="w-full rounded-xl border border-line bg-raised px-3.5 py-2.5 text-xs font-semibold text-muted dark:bg-surface/[0.02] dark:text-faint cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-line bg-canvas px-3.5 py-2.5 text-xs text-ink placeholder:text-faint focus:border-accent focus:bg-white focus:outline-none dark:bg-surface/[0.03] transition leading-relaxed"
                />
              </div>
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-accent px-5 py-2.5 text-xs font-bold text-white shadow-md shadow-accent/25 hover:bg-accent-hover active:scale-95 disabled:opacity-50 transition"
                >
                  {updatingBio && <CircleNotch className="h-3.5 w-3.5 animate-spin" />}
                  Lưu tiểu sử
                </button>
              </div>
            </form>
          ...
          <div className="rounded-3xl border border-line bg-surface p-6 sm:p-8 shadow-sm/80 space-y-5">
            <div>
              <h2 className="text-base font-bold text-ink flex items-center gap-2">
                <Key className="h-4 w-4 text-accent dark:text-rose-600" />
                Đổi mật khẩu
              </h2>
              <p className="text-xs text-muted mt-1">
            ...
            {passwordMessage && (
              ...
              >
                {passwordMessage.type === 'success' ? (
                  ...
                  <WarningCircle className="h-4 w-4 shrink-0 text-rose-600" />
                )}
            ...
            <form onSubmit={handleUpdatePassword} className="space-y-4">
              ...
              <div className="flex justify-end pt-2">
                <button
                  ...
                  className="inline-flex items-center gap-2 rounded-xl bg-zinc-900 px-5 py-2.5 text-xs font-bold text-white shadow-sm hover:bg-zinc-800 dark:bg-surface dark:text-ink active:scale-95 disabled:opacity-50 transition"
                >
                  {updatingPassword && <CircleNotch className="h-3.5 w-3.5 animate-spin" />}
                  Cập nhật mật khẩu
                </button>
              </div>
            </form>
