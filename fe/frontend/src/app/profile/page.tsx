      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pt-10 space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 sm:p-8 shadow-sm dark:border-white/[0.08] dark:bg-[#0c121e]/80 space-y-5">
            <div>
              <h2 className="text-base font-bold text-zinc-950 dark:text-white flex items-center gap-2">
                <User className="h-4 w-4 text-accent dark:text-rose-600" />
                Thông tin tài khoản
              </h2>
            ...
            <form onSubmit={handleUpdateBio} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-zinc-200 bg-zinc-50 px-3.5 py-2.5 text-xs text-zinc-950 placeholder-zinc-400 focus:border-accent focus:bg-white focus:outline-none dark:border-white/10 dark:bg-white/[0.03] dark:text-white dark:placeholder-zinc-500 transition leading-relaxed"
                />
              </div>
          ...
          <div className="rounded-3xl border border-zinc-200/80 bg-white p-6 sm:p-8 shadow-sm dark:border-white/[0.08] dark:bg-[#0c121e]/80 space-y-5">
            <div>
              <h2 className="text-base font-bold text-zinc-950 dark:text-white flex items-center gap-2">
                <KeyRound className="h-4 w-4 text-accent dark:text-rose-600" />
                Đổi mật khẩu
              </h2>
              <p className="text-xs text-zinc-500 dark:text-zinc-400 mt-1">
